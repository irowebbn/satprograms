...
max_c = [0]
max_rd = 0
t1 = ax1.text(5, 200, "Max clauses satisfied: " + str(max_c),bbox=dict(facecolor='red', alpha=0.5))
t2 = ax1.text(5, 195, "Flips: 0\nClauses satisfied: 0", bbox=dict(facecolor='red', alpha=0.5))
...
#plt.show()
ani.save('walk_unsat_example.mp4', writer=writer)